...
namespace BibaFramework.BibaGame
{
    public class EquipmentSelectContext : BaseBibaMenuContext 
    {
        ...
        {
			commandBinder.Bind<EndSignal>().To<EquipmentSelectContextEndCommand>().To<CheckForFirstEquipmentInputPointsEventCommand>().To<LogLocationInfoCommand>().To<SendQuadtileIdToServerCommand>().InSequence();
