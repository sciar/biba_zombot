...
namespace BibaFramework.Utility
{
    static class TileSystem
    {
        ...
        /// <summary>
        /// Converts a LatLong into tile QuadKey.
        /// </summary>
        ...
        public static string LatLongToQuadKey(double latitude, double longtitude, int levelOfDetail)
        {
            int pixelX = 0;
            int pixelY = 0;

            LatLongToPixelXY(latitude, longtitude, levelOfDetail, out pixelX, out pixelY);
