...
{
    public abstract class BaseSceneBasedMediator : Mediator 
    {
        [Inject]
        public SetupMenuSignal SetupMenuSignal { get; set; }

        [Inject]
        public PlaySceneBasedMenuStateEntryAnimationSignal PlaySceneMenuStateEntryAnimationSignal { get; set; }
       
        [Inject]
        public PlaySceneBasedMenuStateExitAnimationSignal PlaySceneMenuStateExitAnimationSignal { get; set; }

        [Inject]
        public SceneBasedMenuStateEntryAnimationEndedSignal SceneMenuStateEntryAnimationEndedSignal { get; set; }

        [Inject]
        public SceneBasedMenuStateExitAnimationEndedSignal SceneMenuStateExitAnimationEndedSignal { get; set; }

        public abstract BaseSceneBasedView View { get; }
